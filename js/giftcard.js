...
function actualizarPreview(campo){
    if(campo.id == constantes.inputDestinatario || campo.id == constantes.inputdMonto){
...
function actualizarClases(campo){
    ...
    switch(select){
        case constantes.eleccionColor:
            //console.log("CAMBIAR COLOR DE TEXTO");
        ...
        case constantes.eleccionFuente:
            //console.log("CAMBIAR TAMAÑO DE TEXTO");
        ...
        case constantes.eleccionUbicacion:
            //console.log("CAMBIAR UBICACION DE VALOR");
